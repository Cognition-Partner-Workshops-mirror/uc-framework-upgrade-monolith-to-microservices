...
// Updated for DGS 8.x / graphql-java 21+:
// The interface method is now handleException() returning CompletableFuture
@Component
public class GraphQLCustomizeExceptionHandler implements DataFetcherExceptionHandler {

  // Migrated from onException() to handleException() (graphql-java 21+ API change)
  @Override
  public CompletableFuture<DataFetcherExceptionHandlerResult> handleException(
    ...
    if (handlerParameters.getException() instanceof InvalidAuthenticationException) {
      ...
      // Delegate to default handling for unrecognized exceptions
      return CompletableFuture.completedFuture(
